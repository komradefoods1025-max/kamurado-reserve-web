                  ...
                  return (
                    <article key={item.id} className={styles.itemCard}>
                      <div className={styles.itemHeader}>
                        <div className={styles.itemMain}>
                          ...
                          <div className={styles.itemPriceDesktop}>
                            ¥{unitPrice.toLocaleString("ja-JP")} / 1点
                          </div>

                          <p className={styles.itemPriceMobile}>
                            ¥{unitPrice.toLocaleString("ja-JP")} × {quantity}{" "}
                      ...
                      <div className={styles.itemActions}>
                        ...
                        >
                          <span className={styles.removeBtnLabelDesktop}>
                            この商品を削除
                          </span>
                          <span className={styles.removeBtnLabelMobile}>削除</span>
                        </button>
                      </div>
